...
function APActionsContent() {
  ...
  const handleCreateETF = async () => {
    ...
    try {
      ...
      showSuccess(`ETF creation successful: ${etfQuantity} ${etfSymbol} shares created`);
    } catch (err) {
      ...
      showSuccess(`ETF creation initiated: ${etfQuantity} ${etfSymbol} shares (Note: Run backend script to update CDP registry)`);
